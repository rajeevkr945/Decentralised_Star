...
// #define GATTS_SERVICE_UUID_TEST_A 0x00FF // change it to More meaningfull UUID
// #define GATTS_CHAR_UUID_TEST_A 0xFF01
// #define GATTS_NUM_HANDLE_TEST_A 4

// #define GATTS_SERVICE_UUID_TEST_B 0x00EE // change it to More meaningfull UUID
...
// static const char remote_device_name[] = "ESP_GATTS_DEMO"; // advertisment name
...
//     uint16_t char_handle;
//     esp_bd_addr_t remote_bda; // remote
// };
...
//     .scan_interval = 0x50,
//     .scan_window = 0x30,
//     .scan_duplicate = BLE_SCAN_DUPLICATE_ENABLE_RESET};
...
//     printf("GATTC_PROFILE_C_APP_ID=%d\n", GATTC_PROFILE_C_APP_ID);
